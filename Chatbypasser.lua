--[[
API KEY: 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
AUTHOR: VXKXDEN
VERSION 0.1
(UNRELEASED)
]]
...
local function Notification1()
CoreGui:SetCore("SendNotification", {
	Title = "Made by VxKxden";
	Text = "Script loaded.";
	Duration = 5;
})
end
local function Notification2()
CoreGui:SetCore("SendNotification", {
	Title = "Chat BYPASSER";
	Text = "Version 0.1";
	Duration = 5;
...
local Window = OrionLib:MakeWindow({Name = "Kaden's Chat Bypasser", HidePremium = false, IntroText = "Kaden's Chat Bypasser", SaveConfig = false})
